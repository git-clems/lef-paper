...
if model.status == GRB.OPTIMAL:
    print(Y)
    print(f"Stochastic solution : {model.ObjVal}")
    c_1 = quicksum(prob[s] *(pO[s,t] * XO_val[s,t] + pC[s,t] * XC_val[s,t]) for t in T for s in S)
    c_2 = quicksum(prob[s] *(buy_price[s,t] * Buy_val[s,t] - sold_price[s,t] * Sold_val[s,t]) for t in T for s in S)
    cost = c_1+c_2
    print("Stochastic : ",cost)
