...
# print(f'The mean run time of QL-VNS for each instance is {vns_ql_time}')
# print(f'The mean run time of VNS for each instance is {vns_time}')
# print(f'The mean run time of SA for each instance is {sa_time}')

# print(f'The mean cost of QL-VNS for each instance is {vns_ql_cost}')
# print(f'The mean cost of VNS for each instance is {vns_cost}')
# print(f'The mean cost of SA for each instance is {sa_cost}')