...
problem_data = {
    ...
    'eO': eO, 'eC': eC, 'E_max': E_max, V : 'V', u : 'u'
}
...
def Q_VNS(max_iterations, data, alpha=0.1, gamma=0.9, epsilon=0.1):
    ...
    actions = list(range(1, MAX_NEIGHBORHOOD)) # Corresponds to k=1, 2, 3, 4
...
Y_opt, cost_opt, t_hist_ql, c_hist_ql = Q_VNS(max_iterations=MAX_ITER, data=problem_data)
